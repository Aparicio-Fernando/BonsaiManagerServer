        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bonsais_Species_SpeciesId",
                        column: x => x.SpeciesId,
                        principalTable: "Species",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bonsais_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CareRecords_Bonsais_BonsaiId",
                        column: x => x.BonsaiId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bonsais_SpeciesId",
                table: "Bonsais",
                column: "SpeciesId");

            migrationBuilder.CreateIndex(
                name: "IX_Bonsais_UserId",
                table: "Bonsais",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CareRecords_BonsaiId",
                table: "CareRecords",
                column: "BonsaiId");
